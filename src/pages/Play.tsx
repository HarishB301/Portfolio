...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Harish B 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/PassPhoto.jpeg" alt="Harish" />
              </div>
              <div className="player-details">
                <span className="player-name">Harish</span>
                <span className="player-rating">{engineThinking ? '🤔 Thinking...' : 'Hari 301'}</span>
              </div>
            </div>
